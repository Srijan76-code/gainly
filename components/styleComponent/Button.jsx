const Button = ({ children,bg }) => {
    return (
      <button
        type="submit"
        className={`relative z-10 px-6 py-2 overflow-hidden border rounded-full group font-sans flex justify-center items-center gap-2  text-sm text-white ${bg} backdrop-blur-md shadow-xl lg:font-semibold border-white`}
      >
