...
export default function Cta() {
    return (
        <div className="  space-y-3 md:space-y-8 max-w-4xl mx-auto flex flex-col text-center items-center justify-center p-10 sm:p-20 md:p-30 bg-[#07080A] bg-no-repeat bg-cover" style={{ backgroundImage: "url('./hero/bg-lines.png')" }} >
